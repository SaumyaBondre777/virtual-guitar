...
- Hand x-position maps to 6 strings (ponytail: divide width by 7, no calibration)
...
2. Process with MediaPipe Hands (ponytail: results.multi_hand_landmarks)
...
- Python (ponytail: 3.11+, no version pinning overhead)
